...
public class AnimalChessConst {
    ...
    //FLAG SETTING
    public static final int FLAG_SIZE 			= 58;
    public static final int FLAG_HALF_SIZE		= FLAG_SIZE/2;
    
    //BOARD SETTING
    public static final int LEFT_MARGIN = 71 / 2 - FLAG_HALF_SIZE;	 //Left Margin of Main Panel, left spacing between the screen and the board left edge
    public static final int TOP_MARGIN = 71 / 2 - FLAG_HALF_SIZE;	 //Top Margin of  Main Panel, top spacing between the screen and the board top edge
    public static final float LINE_WIDTH = 2.5f;
    public static final int MENU_WIDTH = 25;
    public static final int LINE_INTERVAL = 71;	//Change this value will change the board size
