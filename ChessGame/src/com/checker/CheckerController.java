...
public class CheckerController extends BoardGameController {

	ChessPiece flowChessPiece = null;
	
	public CheckerController() {
		super(new CheckerModel(), new CheckerView());
	}
	...
	public ActionListener getBoardGameOptionButtonListener() {
		return new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				System.out.println("Checker : Option Button");
			}
		};
	}
	...
	public MouseListener getBoardGameMouseListener() {
		return new MouseAdapter(){
			...
			public void mousePressed(MouseEvent e) {
				...
				CheckerModelVO data = (CheckerModelVO)getBoardGameModel().getModelVO();
